...
<%
	...
	PreparedStatement st2=conn.prepareStatement("select * from msg where sender=?");
	...
	String msg1[][] = new String[count][4];
	PreparedStatement st1 = conn.prepareStatement("select receiver,content,cdate,msgid from msg where sender=?");
  ...
  <div class="wrapper ">
    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          <li class="nav-item  ">
            <a class="nav-link" href="CreateMsg.jsp">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Sent</a>
          </div>
