...
<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="NewsServlet" method="get">
				<span class="contact100-form-title">
					Upload News
				</span>
<div class="wrap-input100 validate-input" data-validate="Name is required">
					<span class="label-input100">Title</span>
					<input class="input100" type="text" name="tf1" placeholder="Enter Title" reqired>
					<span class="focus-input100"></span>
				</div>
<div class="wrap-input100 validate-input" data-validate="Name is required">
					<span class="label-input100">Document Name</span>
					<input class="input100" type="text" name="tf2" placeholder="Enter Document Name" reqired>
					<span class="focus-input100"></span>
				</div>
