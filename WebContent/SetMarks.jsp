...
<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="UploadMarkServlet" method="post">
				<span class="contact100-form-title">
					Internal Marks
				</span>
					<div class="wrap-input100 validate-input" data-validate="Name is required">
					<span ><p>Student Name: <%=name %></p></span>
				</div>
				<div class="wrap-input100 validate-input" data-validate="Name is required">
					<span ><p>Year:  <%=year%></p></span>
				</div>
				<div class="wrap-input100 validate-input" data-validate="Name is required">
					<span ><p>Branch:  <%=branch%></p></span>
				</div>
            ...
            <option value="put">PUT</option>
				...
				<div class="wrap-input100 validate-input" data-validate="Roll Number is required">
					<span class="label-input100"><%=sub[i]%></span>
					<input class="input100" type="text" name="tf<%=i%>" placeholder="Enter Marks" required>
				</div>
				<%}%>
