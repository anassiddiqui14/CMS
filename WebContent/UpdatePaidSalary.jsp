  ...
  <div class="wrapper ">
    ...
    <div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="UpdatePaidServlet" method="get">
				<span class="contact100-form-title">
					Salary
				</span>
					<div class="wrap-input100 validate-input" data-validate="Name is required">
					<span ><p>Employee Name: <%=name %></p></span>
				</div>
				<div class="wrap-input100 validate-input" data-validate="Name is required">
					<span ><p>Net Salary:<%=net%></p></span>
				</div>
				<div class="wrap-input100 validate-input" data-validate="Name is required">
					<span class="label-input100">Total Deductions</span>
					<input class="input100" type="text" name="tf1" placeholder="Enter in Rupess" reqired>
