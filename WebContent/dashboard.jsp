...
<body class="">
  <div class="wrapper ">
    ...
    -->
      <div class="logo"><a href="dashboard.jsp" class="simple-text logo-normal">
          Student Dashboard
        </a></div>
      <div class="sidebar-wrapper">
        <ul class="nav">
          <li class="nav-item ">
            <a class="nav-link" href="semAtt.jsp">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="Messaging.jsp">
              <i class="material-icons">M</i>
              <p>Messages</p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="PlacementDivision.jsp">
              <i class="material-icons">P</i>
              <p>Placements</p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="InternalMarks.jsp">
          ...
          <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <p class="card-category">Assignments Received</p>
                  <h3 class="card-title">37
                  </h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons text-danger">date_range</i>
                    <a href="javascript:;">4 min ago</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  ...
                  <h3 class="card-title">90700</h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">date_range</i>Zero dues
                  </div>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                ...
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">date_range</i> Till today
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card card-chart">
                ...
                <div class="card-body">
                  ...
                  <p class="card-category">
                    <span class="text-success"><i class="fa fa-long-arrow-up"></i> 13% </span> increase in this month.</p>
                </div>
                <div class="card-footer">
                  <div class="stats">
            ...
            <div class="col-md-4">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  ...
                  <p class="card-category">Last semester 82.1%</p>
                </div>
                <div class="card-footer">
                  <div class="stats">
            ...
            <div class="col-md-4">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  ...
                  <p class="card-category">Assignment Performance</p>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">access_time</i>Just Updated
