...
alert("Records entered successfully!");
</script>
<!--===============================================================================================-->
  ...
  <div class="wrapper ">
    ...
    <div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="UpdatePaidSalary.jsp" method="get">
				<span class="contact100-form-title">
					Salary
				</span>
					<div class="wrap-input100 validate-input" data-validate="Name is required">
					<span class="label-input100">Employee Id</span>
					<input class="input100" type="text" name="tf1" placeholder="Enter Employee Id" required>
