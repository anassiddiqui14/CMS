...
<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="UploadSubjectsServlet" method="post">
          ...
          %>
				<div class="wrap-input100 validate-input" data-validate="Roll Number is required">
					...
					<input class="input100" type="text" name="g<%=i%>" placeholder="Enter Subject Name" required>
				</div>
				<div class="wrap-input100 validate-input" data-validate="Roll Number is required">
					<span class="label-input100">Subject Code</span>
					<input class="input100" type="text" name="h<%=i%>" placeholder="Enter Subject Code" required>
				</div>
			<%} %>
