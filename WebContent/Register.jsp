  ...
  <div class="wrapper ">
    ...
    <div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="RedirectRegistrationServlet" method="get">
				<span class="contact100-form-title">
					Registration
				</span>

				<div class="wrap-input100 input100-select">
					<span class="label-input100">Registration Type</span>
					<div>
						<select class="selection-2" name="tf1">
							<option>--Select--</option>
        					<option value="Registration">Student</option>
        					<option value="RegisterEmployee">Employee</option>
