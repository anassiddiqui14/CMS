  ...
  <div class="wrapper ">
    ...
    <div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="EmpAttndnceServlet" method="get">
				...
				<div class="wrap-input100 validate-input" data-validate="Name is required">
					...
					<input class="input100" type="text" name="tf1" placeholder="Enter Employee Id" reqired>
					<span class="focus-input100"></span>
				</div>
				<div class="wrap-input100 input100-select">
					<span class="label-input100">Month</span>
					<div>
						<select class="selection-2" name="tf7">
         ...
         <option value="Dec 12">December</option>
				...
				<div class="wrap-input100 input100-select">
					<span class="label-input100">Week 1</span>
					<div>
				...
				<div class="wrap-input100 input100-select">
					<span class="label-input100">Week 2</span>
					<div>
				...
				<div class="wrap-input100 input100-select">
					<span class="label-input100">Week 3</span>
					<div>
						<select class="selection-2" name="tf4">
							<option>--Select--</option>
							<option value="1">1</option>
							<option value="2">2</option>
							<option value="3">3</option>
				...
				<div class="wrap-input100 input100-select">
					<span class="label-input100">Week 4</span>
					<div>
						<select class="selection-2" name="tf5">
							<option>--Select--</option>
							<option value="1">1</option>
							<option value="2">2</option>
							<option value="3">3</option>
				...
				<div class="wrap-input100 input100-select">
					<span class="label-input100">Week 5</span>
					<div>
						<select class="selection-2" name="tf6">
`							<option>--Select--</option>
							<option value="1">1</option>
							<option value="2">2</option>
							<option value="3">3</option>
