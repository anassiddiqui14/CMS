          ...
          <div class="row">
              ...
              <div class="card card-stats">
                ...
                <div class="card-footer">
                  <div class="stats">
                    ...
                    <a href="javascript:;">Just Updated</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                ...
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">update</i> 2 min ago
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card card-chart">
                ...
                <div class="card-body">
                  ...
                  <p class="card-category">
                    <span class="text-success"><i class="fa fa-long-arrow-up"></i> 23% </span> increase in this month.</p>
                </div>
                <div class="card-footer">
                  <div class="stats">
            ...
            <div class="col-md-4">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  ...
                  <p class="card-category">Last revenue report</p>
                </div>
                <div class="card-footer">
                  <div class="stats">
            ...
            <div class="col-md-4">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  ...
                  <p class="card-category">This month performance</p>
                </div>
                <div class="card-footer">
                  <div class="stats">
