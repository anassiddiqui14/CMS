...
<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="AttendanceServlet" method="post">
				<span class="contact100-form-title">
					Set Attendance
				</span>
				<%for(int i=1;i<=count;i++){ %>
				<div class="wrap-input100 input100-select">
					<span class="label-input100"><p><b><%=students[i]%></b></p></span>
					<div>
						<select name="<%=roll[i]%>" class="selection-2">
