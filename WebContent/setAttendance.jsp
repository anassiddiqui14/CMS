...
<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="FetchStudents.jsp" method="get">
				...
				<div class="wrap-input100 input100-select">
					...
					<div>
						<select name="tf1" class="selection-2"><%for(int i=1;i<=31;i++) {%><option value=<%=i %>><%=i %></option><%}%></select>
					</div>
				...
				<div class="wrap-input100 input100-select">
					...
					<div>
						<select name="tf2" class="selection-2"><%for(int i=1;i<=12;i++){ %><option value=<%=i %>><%=i %></option><%} %></select>
					</div>
					<span class="focus-input100"></span>
				</div>
				<div class="wrap-input100 input100-select">
					...
					<div>
						<select name="tf3" class="selection-2">
            <%for(int i=1;i<=num;i++){ %>
