  ...
  <div class="wrapper ">
    ...
    <div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="SalaryServlet" method="get">
				<span class="contact100-form-title">
					...
					<div>
						<select class="selection-2" name="tf1" required>
							<option value="upd">Salary Paid</option>
							<option value="Upload">Upload Salary</option>
						</select>
					</div>
